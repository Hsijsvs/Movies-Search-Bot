...
url_list = {}
api_key = "c58c9e229c93d1997b92881c9a6df57e67afebaa"
...
def get_movie(query):
    ...
    if movie_page_link:
        ...
        final_links = {}
        for i in links:
            url = f"https://mdiskshortner.in/api?api=c58c9e229c93d1997b92881c9a6df57e67afebaa&url=yourdestinationlink.com&alias=CustomAlias"
